...
def create_dataset(half=True):
    ...
    train_ids = ["S02", "S07", "S09", "S10"] #2,7,9,10
    val_ids = ["S02", "S07", "S09", "S10"]
    test_ids = ["S01", "S03", "S04", "S05", "S06", "S08", "S11", "S12", "S13", "S14", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp22/'
