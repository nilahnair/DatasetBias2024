...
def create_dataset(half=True):
    ...
    train_ids = ["S02", "S06", "S12", "S13"] #2,6,12,13
    val_ids = ["S02", "S06", "S12", "S13"]
    test_ids = ["S01", "S03", "S04", "S05", "S07", "S08", "S09", "S10", "S11", "S14", "S15", "S16" ]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp2/'
