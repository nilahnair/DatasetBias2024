...
def create_dataset(half=True):
    ...
    train_ids = ["S02", "S05", "S08", "S14"] #2,5,8,14
    val_ids = ["S02", "S05", "S08", "S14"]
    test_ids = ["S01", "S03", "S04", "S06", "S07", "S09", "S10", "S11", "S12", "S13", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp30/'
