...
def create_dataset(half=True):
    ...
    train_ids = ["S01", "S05", "S07", "S16"] #1,5,7,16
    val_ids = ["S01", "S05", "S07", "S16"]
    test_ids = ["S02", "S03", "S04", "S06", "S08", "S09", "S10", "S11", "S12", "S13", "S14", "S15"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp9/'
