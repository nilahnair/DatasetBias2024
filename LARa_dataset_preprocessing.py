...
def create_dataset(half=True):
    ...
    train_ids = ["S04", "S06", "S08", "S11"] #4,6,8,11
    val_ids = ["S04", "S06", "S08", "S11"]
    test_ids = ["S01", "S02", "S03", "S05", "S07", "S09", "S10", "S12", "S13", "S14", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp5/'
