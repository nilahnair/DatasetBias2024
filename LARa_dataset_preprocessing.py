...
def create_dataset(half=True):
    ...
    train_ids = ["S02", "S06", "S13", "S16"] #2,6,13,16
    val_ids = ["S02", "S06", "S13", "S16"]
    test_ids = ["S01", "S03", "S04", "S05", "S07", "S08", "S09", "S10", "S11", "S12", "S14", "S15"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp3/'
