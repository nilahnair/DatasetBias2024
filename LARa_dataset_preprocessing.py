...
def create_dataset(half=True):
    ...
    train_ids = ["S01", "S02", "S03", "S05"] #1,2,3,5
    val_ids = ["S01", "S02", "S03", "S05"]
    test_ids = ["S04", "S06", "S07", "S08", "S09", "S10", "S11", "S12", "S13", "S14", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp26/'
