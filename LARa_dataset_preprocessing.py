...
def create_dataset(half=True):
    ...
    train_ids = ["S04", "S05", "S07", "S15"] #4,5,7,15
    val_ids = ["S04", "S05", "S07", "S15"]
    test_ids = ["S01", "S02", "S03", "S06", "S08", "S09", "S10", "S11", "S12", "S13", "S14", "S16" ]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp19/'
