...
def create_dataset(half=True):
    ...
    train_ids = ["S05", "S09", "S10", "S14"] #5,9,10,14
    val_ids = ["S05", "S09", "S10", "S14"]
    test_ids = ["S01", "S02", "S03", "S04", "S06", "S07", "S08", "S11", "S12", "S13", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp7/'
