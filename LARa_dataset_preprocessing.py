...
def create_dataset(half=True):
    ...
    train_ids = ["S04", "S09", "S11", "S15"] #4,9,11,15
    val_ids = ["S04", "S09", "S11", "S15"]
    test_ids = ["S01", "S02", "S03", "S05", "S06", "S07", "S08", "S10", "S12", "S13", "S14", "S16" ]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp21/'
