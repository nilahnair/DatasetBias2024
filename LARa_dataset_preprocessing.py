...
def create_dataset(half=True):
    ...
    train_ids = ["S01", "S02", "S09", "S14"] #1,2,9,14
    val_ids = ["S01", "S02", "S09", "S14"]
    test_ids = ["S03", "S04", "S05", "S06", "S07", "S08", "S10", "S11", "S12", "S13", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp24/'
