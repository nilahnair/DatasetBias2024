...
def create_dataset(half=True):
    ...
    train_ids = ["S03", "S08", "S09", "S11"] #3,8,9,11
    val_ids = ["S03", "S08", "S09", "S11"]
    test_ids = ["S01", "S02", "S04", "S05", "S06", "S07", "S10", "S12", "S13", "S14", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp14/'
