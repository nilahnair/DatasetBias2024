...
def create_dataset(half=True):
    ...
    train_ids = ["S01", "S03", "S04", "S07"] #1,3,4,7
    val_ids = ["S01", "S03", "S04", "S07"]
    test_ids = ["S02", "S05", "S06", "S08", "S09", "S10", "S11", "S12", "S13", "S14", "S15", "S16"]
    ...
    if half:
        ...
        base_directory = '/data/nnair/datasetbias/lara/prepros/exp27/'
