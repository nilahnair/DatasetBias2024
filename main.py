...
ex= Experiment('motionsense cnntrans x3 exp17')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    num_tr_inputs = {'mocap': 345417, 'mbientlab': 94753, 'mobiact': 160561, 'motionsense': 19946, 'sisfall': 118610}
    ...
    if output[output_idx] == 'softmax':
        ...
        folder_exp = {'mocap': "/data/nnair/icpr2024/lara/results/transt/",
                    ...
                    'motionsense': "/data/nnair/datasetbias/motionsense/results/exp17/cnntrans/",
    ...
    dataset_root = {'mocap': "/data/nnair/icpr2024/lara/prepros/",
                    ...
                    'motionsense': "/data/nnair/datasetbias/motionsense/prepros/exp17/",
