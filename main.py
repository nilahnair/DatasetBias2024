...
ex= Experiment('lara cnntrans x3 exp22')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    num_tr_inputs = {'mocap':83708, 'mbientlab': 94753, 'mobiact': 160561, 'motionsense': 20033, 'sisfall': 118610}
    ...
    if output[output_idx] == 'softmax':
        labeltype = "class"
        folder_exp = {'mocap': "/data/nnair/datasetbias/lara/results/exp22/cnntrans/",
    ...
    dataset_root = {'mocap': "/data/nnair/datasetbias/lara/prepros/exp22/",
