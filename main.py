...
ex= Experiment('sisfall cnntrans x3 exp13')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    num_tr_inputs = {'mocap':64376, 'mbientlab': 94753, 'mobiact': 160561, 'motionsense': 20033, 'sisfall': 25679}
    ...
    if output[output_idx] == 'softmax':
        ...
        folder_exp = {'mocap': "/data/nnair/datasetbias/lara/results/exp32/cnntrans/",
                    ...
                    'sisfall': "/data/nnair/datasetbias/sisfall/results/exp13/cnntrans/"
                    }
    ...
    dataset_root = {'mocap': "/data/nnair/datasetbias/lara/prepros/exp32/",
                    ...
                    'sisfall': "/data/nnair/datasetbias/sisfall/prepros/exp13/"
                    }
