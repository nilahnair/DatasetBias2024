...
def main():
    ...
    train_ids= ['SA07','SA11', 'SA20', 'SA21'] #7,11,20,21
    test_ids= ['SA01','SA02', 'SA03', 'SA04', 'SA05', 'SA06', 
                'SA08', 'SA09', 'SA10', 'SA12', 'SA13', 'SA14', 
                'SA15', 'SA16', 'SA17', 'SA18', 'SA19',  
                'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp31/'
