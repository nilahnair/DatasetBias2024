...
def main():
    ...
    train_ids= ['SA02','SA06', 'SA18', 'SA20'] #2,6,18,20
    test_ids= ['SA01', 'SA03', 'SA04', 'SA05', 'SA07', 
                'SA08', 'SA09', 'SA10', 'SA11', 'SA12', 'SA13', 'SA14', 
                'SA15', 'SA16', 'SA17', 'SA19', 'SA21', 
                'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp22/'
