...
def main():
    ...
    train_ids= ['SA02','SA10', 'SA11', 'SA15'] #2,10,11,15
    test_ids= ['SA01', 'SA03', 'SA04', 'SA05', 'SA06', 'SA07', 
                'SA08', 'SA09', 'SA12', 'SA13', 'SA14', 
                'SA16', 'SA17', 'SA18', 'SA19', 'SA20', 'SA21', 
                'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp23/'
