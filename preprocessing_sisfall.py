...
def main():
    ...
    train_ids= ['SA04','SA08', 'SA15', 'SA20'] #4,8,15,20
    test_ids= ['SA01','SA02', 'SA03', 'SA05', 'SA06', 'SA07', 
                'SA09', 'SA10', 'SA11', 'SA12', 'SA13', 'SA14', 
                'SA16', 'SA17', 'SA18', 'SA19', 'SA21', 
                'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp29/'
