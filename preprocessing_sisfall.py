...
def main():
    ...
    train_ids= ['SA03','SA10', 'SA17', 'SA19'] #3,10,17,19
    test_ids= ['SA01','SA02', 'SA04', 'SA05', 'SA06', 'SA07', 
                'SA08', 'SA09', 'SA11', 'SA12', 'SA13', 'SA14', 
                'SA15', 'SA16', 'SA18', 'SA20', 'SA21', 
                'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp24/'
