...
def main():
    ...
    train_ids= ['SA07','SA10', 'SA19', 'SA20'] #7,10,19,20
    test_ids= ['SA01','SA02', 'SA03', 'SA04', 'SA05', 'SA06',  
                'SA08', 'SA09', 'SA11', 'SA12', 'SA13', 'SA14', 
                'SA15', 'SA16', 'SA17', 'SA18', 'SA21', 
                'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp33/'
