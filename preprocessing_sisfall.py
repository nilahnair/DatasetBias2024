...
def main():
    ...
    train_ids= ['SA01','SA04', 'SA16', 'SA21'] #1,4,16,21
    test_ids= ['SA02', 'SA03', 'SA05', 'SA06', 'SA07', 
                'SA08', 'SA09', 'SA10', 'SA11', 'SA12', 'SA13', 'SA14', 
                'SA15', 'SA17', 'SA18', 'SA19', 'SA20',  
                'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp20/'
