...
def main():
    ...
    #train_ids= ['SA05','SA06', 'SA10', 'SA15'] #2,5,11,17
    test_ids= ['SA01','SA03', 'SA04', 'SA06', 'SA07', 
                'SA08', 'SA09', 'SA10',  'SA12', 'SA13', 'SA14', 
                'SA15', 'SA16', 'SA18', 'SA19', 'SA20', 'SA21', 
               'SA22', 'SA23']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp10/'
