...
def main():
    ...
    #train_ids= ['SA05','SA06', 'SA10', 'SA15'] #7,12,20,23
    test_ids= ['SA01','SA02', 'SA03', 'SA04', 'SA05', 'SA06',  
                'SA08', 'SA09', 'SA10', 'SA11',  'SA13', 'SA14', 
                'SA15', 'SA16', 'SA17', 'SA18', 'SA19', 'SA21', 
                'SA22']
    ...
    base_directory ='/data/nnair/datasetbias/sisfall/prepros/exp13/'
    ...
    generate_data(test_ids, activities, sliding_window_length=200, sliding_window_step=50, data_dir=base_directory, usage_modus='test')
